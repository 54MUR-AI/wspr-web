-- Allow admin and moderator users to delete any message in Public workspace channels
...
-- 2. Admin/Mod users to delete any message in Public workspace channels
