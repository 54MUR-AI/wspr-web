      ...
      {workspaces.map((workspace) => (
        <div key={workspace.id} className="relative group">
          ...
          <button
            ...
            className="absolute -top-1 -right-1 w-4 h-4 bg-samurai-black border border-samurai-red rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity"
          >
            <Trash2 className="w-2.5 h-2.5 text-samurai-red" />
          </button>
        </div>
      ))}
